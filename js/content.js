window.addEventListener('load',()=>{
    ...
    function scrollContent(){
        ...
        if(scrollHeight>=700){
            gsap.to(icon[0],{scale:1,duration:0.7,ease:'power4.out',delay:0.2})
            gsap.to(icon[2],{scale:1,duration:0.7,ease:'power4.out',delay:0.3})
            gsap.to(icon[4],{scale:1,duration:0.7,ease:'power4.out',delay:0.4})
            gsap.to(icon[1],{scale:1,duration:0.7,ease:'power4.out',delay:0.5})
            gsap.to(icon[3],{scale:1,duration:0.7,ease:'power4.out',delay:0.6})
            gsap.to(icon[5],{scale:1,duration:0.7,ease:'power4.out',delay:0.7})
        }
